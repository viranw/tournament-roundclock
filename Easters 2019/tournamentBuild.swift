...
func initialBuild() {
   ...
   allRounds.append(round(seq: 1, label_long: "Round 2", label_short: "R2", status: "Estimated", schedStart:cal.date(from: DateComponents(timeZone: tz, year:2019,month:4,day:19,hour:13,minute:0,second:0))!))
    allRounds.append(round(seq: 1, label_long: "Round 3", label_short: "R3", status: "Estimated", schedStart:cal.date(from: DateComponents(timeZone: tz, year:2019,month:4,day:19,hour:16,minute:0,second:0))!))
